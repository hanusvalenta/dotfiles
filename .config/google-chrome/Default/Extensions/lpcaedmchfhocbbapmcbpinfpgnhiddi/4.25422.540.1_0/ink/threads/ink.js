...
var ASM_CONSTS = {
  315e3: ($0, $1, $2, $3) => setTimeout(() => window.inkWasmRegistry[$3].dynCalls["vi"]($1, $2), $0),
  315085: $0 => {
    clearTimeout($0);
  },
  315107: ($0, $1) => {
  ...
  315537: $0 => window.inkHostRegistry[$0].shouldPreloadShaders(),
  315599: $0 => window.inkHostRegistry[$0].shouldRegisterDocument(),
  315663: ($0, $1, $2, $3, $4, $5) => {
  ...
  318905: () => (typeof wasmOffsetConverter !== "undefined")
};
