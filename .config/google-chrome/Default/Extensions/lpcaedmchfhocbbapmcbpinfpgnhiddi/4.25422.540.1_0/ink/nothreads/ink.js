...
var ASM_CONSTS = {
  314316: ($0, $1, $2, $3) => { return setTimeout( () => window.inkWasmRegistry[$3].dynCalls["vi"]($1, $2), $0); },  
 314401: ($0) => { clearTimeout($0); },  
 314423: ($0, $1) => { window.inkHostRegistry[$1].setTargetFPS($0); },  
 314472: ($0) => { window.inkHostRegistry[$0].bindScreen(); },  
 314517: ($0, $1) => { window.inkHostRegistry[$1].requestImage(UTF8ToString($0)); },  
 314580: ($0, $1, $2, $3) => { window.inkHostRegistry[$3].setCursor($0, $1, $2); },  
 314634: ($0, $1, $2) => { window.inkHostRegistry[$2].navigateToUri(UTF8ToString($0, $1)); },  
 314702: ($0, $1) => { window.inkHostRegistry[$1].setKeyboardMode($0); },  
 314754: ($0, $1, $2) => { window.inkHostRegistry[$2].onAccessibilityData( new Uint8Array(HEAPU8.subarray($0, $0 + $1))); },  
 314853: ($0) => { return window.inkHostRegistry[$0].shouldPreloadShaders(); },  
 314915: ($0) => { return window.inkHostRegistry[$0].shouldRegisterDocument(); },  
 314979: ($0, $1, $2, $3, $4, $5) => { const buf = window.inkHostRegistry[$5].renderText( HEAPU8.subarray($0, $0 + $1), $2, $3); HEAP8.set(buf, $4); },  
 315093: ($0, $1, $2, $3, $4, $5) => { const name = window.inkHostRegistry[$0].selectMatchingFont( UTF8ToString($1, $2), $3, !!$4, $5); if (name) { const size = lengthBytesUTF8(name) + 1; const tempBuffer = _malloc(size); stringToUTF8(name, tempBuffer, size); return tempBuffer; } return 0; },  
 315349: ($0, $1, $2) => { window.inkHostRegistry[$2].onSceneChange( new Uint8Array(HEAPU8.subarray($0, $0 + $1))); },  
 315442: ($0, $1, $2, $3, $4, $5, $6, $7, $8) => { window.inkHostRegistry[$8].onImageExported( $0, $1, $2, new Uint8ClampedArray(HEAPU8.subarray($3, $3 + $4)), $5, $6, UTF8ToString($7)); },  
 315582: ($0, $1, $2) => { window.inkHostRegistry[$2].onToolEvent( new Uint8Array(HEAPU8.subarray($0, $0 + $1))); },  
 315673: ($0, $1) => { window.inkHostRegistry[$1].onSequencePointReached($0); },  
 315732: ($0, $1, $2) => { window.inkHostRegistry[$2].onFlagChanged($0, !!$1); },  
 315788: ($0) => { window.inkHostRegistry[$0].onCameraChanged(); },  
 315838: ($0, $1) => { window.inkHostRegistry[$1].onCameraMovementStateChanged(!!$0); },  
 315905: ($0, $1) => { window.inkHostRegistry[$1].onBlockingStateChanged(!!$0); },  
 315966: ($0) => { window.inkHostRegistry[$0].onInvisibleLayerActionPrevented(); },  
 316032: ($0, $1, $2) => { window.inkHostRegistry[$2].onPdfLoadSuccess( new Uint8Array(HEAPU8.subarray($0, $0 + $1))); },  
 316128: ($0) => { window.inkHostRegistry[$0].onPdfLoadPasswordRequired(); },  
 316188: ($0, $1, $2) => { window.inkHostRegistry[$2].onPdfLoadFailure(UTF8ToString($0, $1)); },  
 316259: ($0, $1, $2, $3) => { window.inkHostRegistry[$3].onPdfSaveSuccess( $0, new Uint8Array(HEAPU8.subarray($1, $1 + $2))); },  
 316359: ($0, $1, $2, $3) => { window.inkHostRegistry[$3].onPdfSaveFailure($0, UTF8ToString($1, $2)); },  
 316434: ($0, $1) => { window.inkHostRegistry[$0].onPdfUnsupportedFeature($1); },  
 316494: ($0) => { window.inkHostRegistry[$0].onPdfFormChanged(); },  
 316545: ($0, $1, $2, $3, $4, $5, $6, $7) => { window.inkHostRegistry[$0].onPdfFormFieldFocused( $1, new Uint8Array(HEAPU8.subarray($2, $2 + $3)), $4, !!$5, UTF8ToString($6, $7)); },  
 316682: ($0, $1, $2) => { window.inkHostRegistry[$2].onPdfFormTextFieldFocusChanged( true, UTF8ToString($0, $1)); },  
 316774: ($0) => { window.inkHostRegistry[$0].onPdfFormTextFieldFocusChanged(false); },  
 316844: ($0, $1) => { window.inkHostRegistry[$1].onPendingTexturesChanged(!!$0); },  
 316907: ($0, $1, $2) => { const canvas = self.WorkerGlobalScope ? new OffscreenCanvas(128, 128) : document.createElement('canvas'); const gl = canvas.getContext('webgl'); if (gl) { const di = gl.getExtension('WEBGL_debug_renderer_info'); if (di) { stringToUTF8(gl.getParameter(di.UNMASKED_RENDERER_WEBGL), $0, $2); stringToUTF8(gl.getParameter(di.UNMASKED_VENDOR_WEBGL), $1, $2); } } },  
 317269: () => { return !!GLctx },  
 317286: () => { debugger },  
 317299: ($0, $1, $2, $3, $4) => { window.inkHostRegistry[$0].onFatalError(UTF8ToString($1, $2), UTF8ToString($3, $4)); },  
 317388: () => { return (typeof wasmOffsetConverter !== 'undefined'); }
};
...
var _shouldOnlyDrawLineToolUpdate,
  _draw,
  _malloc,
  _free,
  ___getTypeName,
...
function assignWasmExports(wasmExports) {
  Module['_shouldOnlyDrawLineToolUpdate'] = _shouldOnlyDrawLineToolUpdate = wasmExports['shouldOnlyDrawLineToolUpdate'];
  Module['_draw'] = _draw = wasmExports['draw'];
  ...
  dynCalls['iiidd'] = dynCall_iiidd = wasmExports['dynCall_iiidd'];
  dynCalls['iidd'] = dynCall_iidd = wasmExports['dynCall_iidd'];
  ...
  dynCalls['iiiifi'] = dynCall_iiiifi = wasmExports['dynCall_iiiifi'];
  dynCalls['iiiiifi'] = dynCall_iiiiifi = wasmExports['dynCall_iiiiifi'];
  dynCalls['iiff'] = dynCall_iiff = wasmExports['dynCall_iiff'];
  dynCalls['iiiff'] = dynCall_iiiff = wasmExports['dynCall_iiiff'];
  ...
  dynCalls['d'] = dynCall_d = wasmExports['dynCall_d'];
  dynCalls['vif'] = dynCall_vif = wasmExports['dynCall_vif'];
  dynCalls['viif'] = dynCall_viif = wasmExports['dynCall_viif'];
  dynCalls['dii'] = dynCall_dii = wasmExports['dynCall_dii'];
  dynCalls['v'] = dynCall_v = wasmExports['dynCall_v'];
  dynCalls['viiiiii'] = dynCall_viiiiii = wasmExports['dynCall_viiiiii'];
  dynCalls['iidi'] = dynCall_iidi = wasmExports['dynCall_iidi'];
  dynCalls['viiif'] = dynCall_viiif = wasmExports['dynCall_viiif'];
  dynCalls['viiiif'] = dynCall_viiiif = wasmExports['dynCall_viiiif'];
  dynCalls['viiiiiiii'] = dynCall_viiiiiiii = wasmExports['dynCall_viiiiiiii'];
  dynCalls['iiiijij'] = dynCall_iiiijij = wasmExports['dynCall_iiiijij'];
  dynCalls['viidi'] = dynCall_viidi = wasmExports['dynCall_viidi'];
  ...
  dynCalls['fiiif'] = dynCall_fiiif = wasmExports['dynCall_fiiif'];
  dynCalls['viidiff'] = dynCall_viidiff = wasmExports['dynCall_viidiff'];
  dynCalls['iiidi'] = dynCall_iiidi = wasmExports['dynCall_iiidi'];
  dynCalls['vidi'] = dynCall_vidi = wasmExports['dynCall_vidi'];
  dynCalls['vidii'] = dynCall_vidii = wasmExports['dynCall_vidii'];
  dynCalls['vifidi'] = dynCall_vifidi = wasmExports['dynCall_vifidi'];
  dynCalls['viiiiiii'] = dynCall_viiiiiii = wasmExports['dynCall_viiiiiii'];
  dynCalls['fif'] = dynCall_fif = wasmExports['dynCall_fif'];
  dynCalls['viidii'] = dynCall_viidii = wasmExports['dynCall_viidii'];
  dynCalls['fiii'] = dynCall_fiii = wasmExports['dynCall_fiii'];
  dynCalls['iiiif'] = dynCall_iiiif = wasmExports['dynCall_iiiif'];
  dynCalls['viiiff'] = dynCall_viiiff = wasmExports['dynCall_viiiff'];
  dynCalls['iiiiid'] = dynCall_iiiiid = wasmExports['dynCall_iiiiid'];
  dynCalls['iiiid'] = dynCall_iiiid = wasmExports['dynCall_iiiid'];
  ...
  dynCalls['vijjj'] = dynCall_vijjj = wasmExports['dynCall_vijjj'];
...
var _kVersionStampPrecookedClientInfoStr = Module['_kVersionStampPrecookedClientInfoStr'] = 9104;var wasmImports = {
  /** @export */
  HaveOffsetConverter,
  /** @export */
