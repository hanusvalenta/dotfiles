...
;// CONCATENATED MODULE: ./src/Teleparty/BrowseScripts/HuluJp/hulujp_browse_injected.js
...
function addNativePartyButton() {
    ...
    const playButton = document.querySelector('[data-tracking-type="play-start"]');
    if (playButton == null) {
        return undefined;
    }
    ...
    nativePartyButton.setAttribute("style", "background: linear-gradient(273.58deg, #9E55A0 0%, #EF3E3A 100%); color: #fff; border: none; margin-left: 0;");
