...
;// CONCATENATED MODULE: ./src/Teleparty/BrowseScripts/Unext/unext_browse_injected.js

function addNativePartyButton() {
    console.log("Adding native party button");
    if (document.getElementById("native-party-button") != null) {
        return undefined;
    }
    const playButton = document.querySelector('[data-testid="videoMainSection-stage-play"]');
    if (playButton == null) {
        return undefined;
    }
    ...
    nativePartyButton.setAttribute("style", "background: linear-gradient(273.58deg, #9E55A0 0%, #EF3E3A 100%); color: #fff; border: none; margin-top: 10px;");
