...
const logger = new Logger("ext:ContentScripts:Fubo:fubo_injected");
window.seekScriptLoaded = true;
window.offset = 0;
const findSeekFunction = function () {
    var _a, _b;
    const el = document.querySelector('[data-testid="player-video-scrub-bar"]');
    ...
    return (_b = (_a = elementRoot[key].child) === null || _a === void 0 ? void 0 : _a.return.return.return.return.memoizedProps) === null || _b === void 0 ? void 0 : _b.onSeekEnd;
};
const seek = (ms) => {
    const seekFn = findSeekFunction();
    if (seekFn) {
        seekFn(0, ms / 1000);
    }
};
...
console.log("FUBO INJECTED SCRIPT");
