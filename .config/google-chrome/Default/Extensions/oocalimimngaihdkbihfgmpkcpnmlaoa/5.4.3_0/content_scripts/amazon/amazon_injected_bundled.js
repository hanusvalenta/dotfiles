    ...
    try {
        ...
        */
        ...
        if (!el.querySelector(".webPlayerUIContainer")) {
            ...
            if (altEl) {
                rootAdProps = altEl === null || altEl === void 0 ? void 0 : altEl._reactRootContainer._internalRoot.current.memoizedState.element.props.context.adPlayback;
                rootTimelineProps = altEl === null || altEl === void 0 ? void 0 : altEl._reactRootContainer._internalRoot.current.child.stateNode.props.context.seekBar.seekBar;
