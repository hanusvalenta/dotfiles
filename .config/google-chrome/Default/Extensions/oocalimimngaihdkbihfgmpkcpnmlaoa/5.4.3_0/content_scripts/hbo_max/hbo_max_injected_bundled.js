...
if (!window.videoIdScriptLoaded) {
    ...
    const _intercept = () => {
        ...
        window.fetch = (...args) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (response.ok && ((_a = response.headers.get("content-type")) === null || _a === void 0 ? void 0 : _a.includes("application/json")) &&
...
const getMetadata = () => { var _a; return (_a = getReactFiber(document.querySelector("[data-testid='content-metadata']"))) === null || _a === void 0 ? void 0 : _a.return.return.memoizedProps.contentMetadata; };
