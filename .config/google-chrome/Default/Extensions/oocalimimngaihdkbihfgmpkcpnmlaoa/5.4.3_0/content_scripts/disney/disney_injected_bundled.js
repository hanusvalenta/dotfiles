...
var seekInteraction = function (e) {
    if (e.source == window) {
        ...
        if (e.data.type && "play" == e.data.type) {
            document.querySelector(".btm-media-player").click();
            document.querySelector(".toggle-play-pause").shadowRoot.querySelector('.play-button').click();
        }
        if (e.data.type && "pause" == e.data.type) {
            document.querySelector(".btm-media-player").click();
            document.querySelector(".toggle-play-pause").shadowRoot.querySelector('.pause-button').click();
        }
    }
};
